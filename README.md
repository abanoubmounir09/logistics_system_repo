...
To assign a driver's system login: open **Logistic Driver** doctype, set the `Linked User`
...
├── logistics/
│   ├── doctype/
│   │   ├── Logistic Driver/            # Driver DocType
│   │   ├── Logistics order/              # Order DocType
│   │   ├── Logistics delivery_run/       # Delivery Run DocType (workflow lives here)
│   │   └── Logistics delivery_stop/      # Delivery Stop - child table of Delivery Run
